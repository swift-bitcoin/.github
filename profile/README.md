...
* Check out key repositories like the [main framework](https://github.com/swift-bitcoin/swift-bitcoin) and [ECC library fork](https://github.com/swift-bitcoin/secp256k1)
* Learn more about [building the project](https://swiftbitcoin.org/docs/documentation/bitcoin/building), [file bugs/feature request](https://github.com/swift-bitcoin/swift-bitcoin/issues) or [contributing](https://github.com/swift-bitcoin/swift-bitcoin/blob/develop/CONTRIBUTING.md)
